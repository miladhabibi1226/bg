            ...
            <div class="mt-3.5 flex gap-2.5 max-xl:flex-wrap">
                ...
                <div class="flex w-[360px] max-w-full flex-col gap-2 max-sm:w-full">
                    ...
                    <x-admin::accordion>
                        <x-slot:header>
                            <p class="p-2.5 text-base font-semibold text-gray-800 dark:text-white">
                                @lang('admin::app.catalog.attributes.create.pricing')
                            </p>
                        </x-slot>
                        ...
                        <x-slot:content>
                            ...
                            <x-admin::form.control-group class="!mb-0 flex select-none items-center gap-2.5">
                                <x-admin::form.control-group.control
                                    ...
                                    value="1"
                                    for="is_priceable"
                                    :checked="(boolean) $attribute->is_priceable"
                                    :disabled="(boolean) $attribute->is_priceable"
                                />
                                ...
                                <label
                                    ...
                                    for="is_priceable"
                                >
                                    @lang('admin::app.catalog.attributes.edit.is-priceable')
                                </label>

                                <x-admin::form.control-group.control
                                    type="hidden"
                                    :name="$type"
                                    :value="$attribute->is_priceable"
                                />
                            </x-admin::form.control-group>
                        </x-slot>
                    </x-admin::accordion>
